...
(function () {
  ...
  async function refreshList(listEl){
    var c=cli(); if(!c){ listEl.innerHTML='<div class="acl-empty"><span class="en-text">Not signed in. Log in as a clinician.</span><span class="ko-text">세션이 없습니다. 임상가로 로그인하세요.</span></div>'; return; }
